...
<head>
    ...
    <title>@yield('title', 'Shreya Life Sciences Pvt Ltd: Samir')</title>
    <link rel="stylesheet" 
         ...
         <li class="nav-item dropdown">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu hoverable" aria-labelledby="crossTabsDropdown">
                    ...
                    <li><a class="dropdown-item" href="{{route('monthEndStocks')}}">MonthEnd Stocks</a></li>
                    <li><a class="dropdown-item" href="{{route('stockExpiry')}}">Stock Expiry</a></li>
                    <li><a class="dropdown-item" href="{{route('depotDeptors')}}">Depot Deptors</a></li>
                    <li><a class="dropdown-item" href="{{route('pendingOrders')}}">Pending Orders</a></li>
                    <li><a class="dropdown-item" href="{{route('depotCollection')}}">Depot Collection</a></li>
                    <li><a class="dropdown-item" href="{{route('advanceCollection')}}">Advance Collection</a></li>
                    <li><a class="dropdown-item" href="{{route('MDDespatches')}}">MD Despatches</a></li>
