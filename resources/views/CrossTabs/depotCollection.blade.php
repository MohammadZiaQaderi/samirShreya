            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <select id="depotshow" name="depotshow" class="form-select" onchange="call()">
                        ...
                        <option value="12">JABALPUR</option>
                        <option value="06">JAMMU</option>
                        <option value="40">JAMSHEDPUR</option>
                        <option value="35">KALYAN</option>
                        <option value="88">KOLKATA</option>
                        <option value="17">KOLKATA C&F</option>
                        <option value="30">MUMBAI</option>
                        <option value="43">MUMBAI</option>
                        <option value="83">MUMBAI - SE</option>
                        <option value="72">MUMBAI MOTHER DEPOT</option>
                        <option value="25">MUMBAI ST</option>
                        <option value="24">MUMBAI ST B/E DEPOT</option>
                        <option value="04">MUMBAI B/E DEPOT</option>
                        <option value="56">MYSORE</option>
                        <option value="09">NAGPUR</option>
                        <option value="53">NALANDA</option>
                        <option value="39">ORISSA</option>
                        <option value="99">RANCHI</option>
                        <option value="58">ROORKEE</option>
                        <option value="71">SILIGURI</option>
                        <option value="50">SURAT</option>
                        <option value="85">TIRUPATI</option>
                        <option value="77">TRICHY</option>
                        <option value="61">VARANASI</option>
                        <option value="20">VISHAPATNAM</option>
                        <option value="76">VIZAG</option>
                        <option value="ALL" selected>ALL</option>
                    </select>
                </div>
