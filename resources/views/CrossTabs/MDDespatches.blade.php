        ...
        <form name="prdselect" method="POST" action="#">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <select id="ctbshow" name="ctbshow" class="form-select">
                ...
                <div class="col-md-3">
                    ...
                    <select id="sbushow" name="sbushow" class="form-select">
                ...
                <div class="col-md-3">
                    ...
                    <select id="tshow" name="tshow" class="form-select">
                ...
                <div class="col-md-3">
                    ...
                    <select id="sqlshow" name="sqlshow" class="form-select">
                ...
                <div class="col-md-3">
                    ...
                    <select id="transhow" name="transhow" class="form-select">
                ...
                <div class="col-md-3">
                    ...
                    <select id="finyrshow" name="finyrshow" class="form-select">
                ...
                <div class="col-md-3">
                    ...
                    <select id="mshow" name="mshow" class="form-select">
                ...
                <div class="col-md-3">
                    ...
                    <select id="sumshow" name="sumshow" class="form-select">
                ...
                <div class="col-md-3">
                    ...
                    <select id="fldshow" name="fldshow" class="form-select">
                ...
                <div class="col-md-3">
                    ...
                    <select id="depotshow" name="depotshow" class="form-select">
                ...
                <div class="col-md-3">
                    ...
                    <select id="colorshow" name="colorshow" class="form-select">
                ...
                <div class="col-md-3">
                    ...
                    <select id="datasheetshow" name="datasheetshow" class="form-select">
                        <option value="YES">YES</option>
                        <option value="NO" selected>NO</option>
                </select>
              </div>
              ...
              <div class="col-md-3">
                    ...
                    <select id="pivotshow" name="pivotshow" class="form-select">
                                <option value="YES">YES</option>
                                <option value="NO" selected>NO</option>
                            </select>
              </div>
